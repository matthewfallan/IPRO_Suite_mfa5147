...
class Atom{
    ...
    public:
        ...
        string moleculeName, residueKind, name, core;
        ...
        float lkRadius, lkLambda, lkVolume, lkGibbs, ljPhi;
        ...
        void load(string text){
            ...
            if (fileFormat == "PDB"){
                ...
                line >> rotamerNumber >> name >> x >> y >> z >> core;}
        ...
        if (forceField == "CHARMM"){
            ...
            for(int i=0; i<ATOMS.size(); i++){
                if (ATOMS[i].vdw != vdw){string temp = "The CHARMM force field "
                    ...
                    cout << ATOMS[i].moleculeName << " " << ATOMS[i].residueNumber << endl;
                    cout << temp << endl; exit(EXIT_FAILURE);}
